...
public class TopRatedTVShowsFragmentViewModel extends TVShowsFragmentViewModel {
    @Override
    protected void getTVShows(boolean isRefresh) {
        mTVShowsServices.getTopRated().subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread())
