...
public class TopRatedMoviesFragmentViewModel extends MoviesFragmentViewModel {
    @Override
    protected void getMovies(boolean isRefresh) {
        moviesServices.getTopRated().subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread())
